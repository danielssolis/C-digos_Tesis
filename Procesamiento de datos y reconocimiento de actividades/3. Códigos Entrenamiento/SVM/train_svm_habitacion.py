...
from sklearn.svm import SVC   # 🔥 CAMBIO
from sklearn.metrics import classification_report, confusion_matrix, accuracy_score
from sklearn.preprocessing import LabelEncoder, StandardScaler  # 🔥 CAMBIO


INPUT_FILE = "data/dataset_habitacion_windows_labeled.csv"

MODEL_FILE = "models/svm_habitacion.joblib"   # 🔥 CAMBIO
ENCODER_FILE = "models/le_habitacion_svm.joblib"  # 🔥 CAMBIO
...
def main():
    ...
    model = Pipeline([
        ...
        ("svm", SVC(
            ...
            # 🔥 importante para balance
            class_weight={0:2, 1:2, 2:2},
