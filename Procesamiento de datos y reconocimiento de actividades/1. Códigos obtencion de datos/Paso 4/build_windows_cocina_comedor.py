...
INPUT_FILE = "data/dataset_cocina_comedor2.csv"
OUTPUT_CSV = "data/dataset_cocina_comedor_windows3.csv"
OUTPUT_XLSX = "data/dataset_cocina_comedor_windows_label3.xlsx"
...
def prepare_excel_for_labeling(xlsx_path: str):
    ...
    # Ajuste estas actividades si luego quiere refinarlas
    ws_list["A1"] = "sin_act_cocina_comedor"
    ws_list["A2"] = "uso_lavaplatos"
    ws_list["A3"] = "cocinando"
    ws_list["A4"] = "consumo_alimentos"
...
def main():
    ...
    # ffill selectivo: no arrastrar distance ni movement
    for col in df.columns:
        c = col.lower()
    ...
    # Excel para etiquetar
    df_excel = df_windows.copy()
    df_excel["timestamp"] = pd.to_datetime(df_excel["timestamp"], utc=True).dt.tz_localize(None)
    ...
    print("\n✅ Dataset ventanas cocina/comedor creado correctamente")
