...
ACTIVITY_BUCKET = "activitiessvm"
ACTIVITY_TOKEN = "-Nkzi1CEjzbNbx1ZMMx1u-DYRGFBG4pM92hu1wOZ92CyXgPGrZpfb5kZa8kOCBfCx9VN9IKaYsHYflR9VMwWww=="
ACTIVITY_MEASUREMENT = "activity_detection_svm"
...
ZONE_CONFIG: Dict[str, ZoneConfig] = {
    "habitacion": ZoneConfig(
        ...
        model_file="models/svm_habitacion.joblib",
        encoder_file="models/le_habitacion_svm.joblib",
        pir_vars=[
    ...
    "sala": ZoneConfig(
        ...
        model_file="models/svm_sala.joblib",
    ...
    "cocina_comedor": ZoneConfig(
        ...
        model_file="models/svm_cocina_comedor.joblib",
        encoder_file="models/le_cocina_comedor_svm.joblib",
        pir_vars=[
